...
from .cluster_info.replication_group_parser import ReplicationGroupParser

log = logging.getLogger(__name__)


class YelpReplicationGroupParser(ReplicationGroupParser):

    def get_replication_group(broker):
